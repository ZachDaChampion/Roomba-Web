...
var app = (function () {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const input_handler = () => {
    		if ($selected === null) return; else if ($selected.dir === "r") set_store_value(grid, $grid[$selected.row][$selected.col].right = slider.value, $grid); else if ($selected.dir === "d") set_store_value(grid, $grid[$selected.row][$selected.col].down = slider.value, $grid);
    	};
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 93, 10, 2127);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 101, 10, 2589);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 90, 4, 1978);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 116, 40, 3231);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div, "display", "flex");
    			set_style(div, "flex-direction", "row");
    			add_location(div, file$1, 115, 4, 3140);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 87, 0, 1847);
    			set_style(div1, "display", "flex");
    			set_style(div1, "flex-direction", "column");
    			add_location(div1, file$1, 113, 0, 3044);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Grid extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { rows: 0, cols: 1 });
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 21, 1, 273);
    			set_style(div0, "margin", "auto");
    			add_location(div0, file$2, 24, 2, 386);
    			set_style(div1, "display", "flex");
    			set_style(div1, "flex-direction", "row");
    			add_location(div1, file$2, 22, 1, 304);
    			attr_dev(main, "class", "svelte-1h6otfa");
    			add_location(main, file$2, 20, 0, 265);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Config, Grid });
    	return [];
    }
