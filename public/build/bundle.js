...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t15 = space();
    			input = element("input");
    			add_location(h20, file, 103, 2, 2359);
    			set_style(hr0, "margin-bottom", "16px");
    			add_location(hr0, file, 104, 2, 2378);
    			set_style(button0, "width", "100%");
    			add_location(button0, file, 105, 2, 2416);
    			set_style(button1, "width", "100%");
    			add_location(button1, file, 106, 2, 2469);
    			add_location(h21, file, 111, 4, 2648);
    			set_style(hr1, "margin-bottom", "16px");
    			add_location(hr1, file, 112, 4, 2681);
    			add_location(p0, file, 113, 4, 2721);
    			add_location(p1, file, 114, 4, 2782);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(span, "left", /*pos*/ ctx[3].x + "px");
    			set_style(span, "top", /*pos*/ ctx[3].y + "px");
    			add_location(span, file$1, 35, 0, 1006);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(span, "mousedown", /*mousedown_handler*/ ctx[10], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["color", "x", "y", "gridW", "gridH"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("gridW" in $$props) $$invalidate(7, gridW = $$props.gridW);
    		if ("gridH" in $$props) $$invalidate(8, gridH = $$props.gridH);
    	};
    ...
    class Endpoint extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { color: 0, x: 5, y: 6, gridW: 7, gridH: 8 });
    		...
    		if (/*gridW*/ ctx[7] === undefined && !("gridW" in props)) {
    			console.warn("<Endpoint> was created without expected prop 'gridW'");
    		}

    		if (/*gridH*/ ctx[8] === undefined && !("gridH" in props)) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 93, 10, 2034);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 101, 10, 2488);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 90, 4, 1888);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 116, 40, 3115);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div, "display", "flex");
    			set_style(div, "flex-direction", "row");
    			add_location(div, file$2, 115, 4, 3025);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 87, 0, 1760);
    			set_style(div1, "display", "flex");
    			set_style(div1, "flex-direction", "column");
    			add_location(div1, file$2, 113, 0, 2931);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 7, 2, 149);
    			set_style(div0, "margin", "auto");
    			add_location(div0, file$3, 12, 4, 418);
    			set_style(div1, "display", "flex");
    			set_style(div1, "flex-direction", "row");
    			set_style(div1, "position", "relative");
    			add_location(div1, file$3, 8, 2, 181);
    			attr_dev(main, "class", "svelte-177t831");
    			add_location(main, file$3, 6, 0, 140);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Config, Endpoint, Grid });
    	return [];
    }
